...
public class MyController {
   ...
   private final PlayerService playerService;
    ...
    public ResponseEntity<List<Player>> getPlayersList(@RequestParam Map<String, String> param){
        Specification<Player> spec = playerService.specificationForCount(param);
        Pageable pageable = playerService.getPageable(param);
    ...
    public ResponseEntity<Player> create(@RequestBody Player player){
        if(playerService.checkForNull(player) && playerService.checkParamValid(player)){
    ...
    public ResponseEntity<Player> update(@PathVariable(name = "id") Long id, @RequestBody Player updPlayer){
        ...
        if(playerService.isExist(id)){
            ...
            if(playerService.checkParamValid(updated)){
